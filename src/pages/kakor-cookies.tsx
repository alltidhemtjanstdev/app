...
const CookiePolicy = () => {
  return (
    <>
      <SeoData title={"Kakor - Alltid Hemtjänst"} />
      <section className="container mx-auto">
        ...
        <div className="mb-10">
          ...
          <p>
            ...
            ihåg inställningar, förbättra prestandan och ge analytisk
            information.
          </p>
        </div>
        <div className="mb-10">
          ...
          <p>
            ...
            personuppgifter, och det finns inga spårnings- eller
            analysfunktioner som kräver kakor.
          </p>
        </div>
        <div className="mb-10">
          ...
          <p>
            ...
            eller stänga av dem genom att ändra inställningarna i din
            webbläsare. På vår webbplats påverkas dock inga funktioner eftersom
            vi inte använder kakor.
          </p>
        </div>
      </section>
    </>
